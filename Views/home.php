...
$view_tweets = [
    [
        ...
        'tweet_created_at' => '2023-02-02 14:00:00',
        'like_id' => null,
        'like_count' => 0,
    ],
    [
...
// 指定した日時からどれだけ通過したかを取得する
// @para string $datetime 日時
// @return string
...
<body class="home">
    <div class="container">
        <div class="side">
            <div class="side-inner">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item my-icon"><img src="<?php echo HOME_URL; ?>Views/img_uploaded/user/iri.png" alt="" class="js-popover" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="right" data-bs-html="true" data-bs-content="<a href='profile.php'>プロフィール</a><br><a href='sign-out.php'>ログアウト</a>"></li>
                </ul>
            </div>
        </div>
        <div class="main">
        ...
        <div class="tweet-list">
            ...
            <div class="tweet">
                <div class="user">
                    <a href="profile.php?user_id=<?php echo $view_tweet['user=id']; ?>">
