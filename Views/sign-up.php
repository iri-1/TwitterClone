...
<body class="signup text-center">
    <main class="form-signup">
        <form action="sign-up.php" class="post">
            ...
            <input type="text" class="form-control" name="name" placeholder="ユーザー名, 例:Techis221" maxlength="50" required>
            <input type="email" class="form-control" name="email" placeholder="メールアドレス" maxlength="254" required>
            <input type="password" class="form-control" name="password" placeholder="パスワード" maxlength="128" required>
